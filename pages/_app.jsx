...
class MainApp extends App {
  render() {
    ...
    return (
      <Container>
        <Head>
          <title>Sarvar Abdurahimov</title>
          <meta property="og:title" content="Sarvar Abdurahimov Portfolio" />
          <meta property="og:description" content="react-native developer from Tashkent" />
          <meta name="description" content="react-native developer from Tashkent" />
